...
| Structured data | Organization (+ parent SKZ), WebSite, WebPage types (with dateModified), BreadcrumbList, Product (no offers/ratings), Article, ImageObject, Place, FAQPage on /talc/, /talc/lumps/, /talc/powder/ (answers are visible on the page). All parse (checker) |
| Sitemap | 20 canonical URLs with image entries (image SEO); excludes thank-you/404/api |
...
| Performance | CLS 0; measured FCP/LCP ≈ 0.8 s; Lighthouse mobile (clean profile, gzip router): Home 83, Talc lumps 80, Contact 90; A11y/BP/SEO 100. Home LCP 4.0 s → 3.0 s after preloading the hero AVIF; homepage HTML 396 KB → 191 KB raw (26 KB gz) |
